...
correct_answers=["Atukulu", "Onam", "sports", "SpaceX", "Chennai Port", "Indian Oil Corporation",
                 "Jan 26,1950", "Mohamed Muizzu", "7th and 31st", "Pith"]

questions=["1.According to puranas, what did Kuchela give to Krishna?",
           "2.Boat Races will be held in Kerala in the significance of the following festival?",
           "3.What category people will receive Arjuna Award?",
           "4.Which company launched the Methane SAT satellite into orbit?",
           "5.Which one of the following ports is the oldest port in India?",
           "6.Which company is set to manufacture fuel for Formula One racing in India?",
           "7.The constitution of India came into force on",
           "8.Who won the Maldives presidential election in 2023?",
           "9.Which of the following constitutional amendments are related to raising the number of members of Lok Sabha to be elected from the states?",
           "10.Which part of the tree Consists of mainly Cellular Tissues?"]

first_option=["Godhumalu", "Pongal",
              "Movies", "NASA",
              "Mumbai Port", "Bharat Petroleum",
              "Jan 26,1948", "Ibrahim Solih",
              "6th and 22nd", "cambium layer"]

second_option=["Puvvulu", "Deewali",
               "Science", "SpaceX",
               "Chennai Port", "Reliance Industries",
               "Jan 26,1950", "Mohamed Muizzu", "13th and 38th", "Bark"]

third_option=["Atukulu", "Onam",
              "sports", "Blue Origin",
              "Kolkata Port", "Indian Oil Corporation",
              "Jan26,1952", "Abdulla Yameen", "7th and 31st", "Heart Wood"]

fourth_option=["Venuvu", "Dusshera",
               "Business", "ISRO",
               "Vishakhapatnam Port","Hindustan Petroleum", "Jan 26,1954","Mohamed Nasheed", "11th and 42nd", "Pith"]
