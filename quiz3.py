...
correct_answers=["Nippukodi", "6", "Maha sivaratri", "India", "United States", "Telangana",
                 "9th Aug,1942", "Attorney General", "7516·6 km", "Japan"]

questions=["1.which is the Big Bird of the following",


           "2.How many digits are there in Indian Pincode?",
           "3.Which of these following  festivals is celebrated as daytime pasting and sleepless night?",
           "4.Where did the game chess born?",
           "5.Which country boasts the world's second-largest road network?",
           "6.Which Indian state recently introduced the 'Maha Lakshmi Scheme,' offering free bus travel for women, girls, and transgender individuals?",
           "7.When did Gandhiji Launch the Quit India Movement?",
           "8.Who is the first Law Officer of the Government of India?",
           "9.The length of the Indian coast line is____________",
           "10.Tsunami is a large sea wave cause by an earthquake experienced along the coast of"]

first_option=["Pichuka", "6",
              "Diwali", "India",
              "United States", "Telangana",
              "9th Aug,1942", "Chief Justice of India", "5024.5 km", "India"]

second_option=["Rabandhu", "4",
               "Ugadi", "China",
               "India", "Kerala",
               "9th Aug,1938", "Union Law Minister", "920 km", "China"]

third_option=["Nippukodi", "7",
              "Maha sivaratri", "Japan",
              "China", "Tamil Nadu",
              "9th Aug,1949", "Attorney General", "7516·6 km", "Australia"]

fourth_option=["Pigeon", "8",
               "Sankranti", "Iran",
               "Russia","Andhra Pradesh", "9th Aug,1944","Law Secretary", "5800 km", "Japan"]
