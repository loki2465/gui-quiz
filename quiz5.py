...
correct_answers=["Saraswati", "Kerala", "Jawaharlal Nehru", "State Bank of India", "Sarojini Naidu", "Charles Darwin",
                 "Vijayawada", "Nelson Mandela", "Khajuraho temples", "Bhagirathi"]

questions=["1.Who is the goddess of speech, wisdom and learning?",
           "2.In which state do the Mansoon Arrives First?",
           "3.Who among the following was India’s longest serving Prime Minister?",
           "4.Which is the biggest commercial bank in public sector in India?",
           "5.Who among the following is popularly known as ‘Nightingale of India’?",
           "6.Who wrote the book “ The Origin of Spieces”?",
           "7.Which city in India has built a 15.8m high “Gandhi Stupa” dedicated to Mahatma Gandhi?",
           "8.“Long Walk to Freedom” is a book written by",
           "9.Famous sculptures depicting art of love built some time in 950 AD – 1050 AD are",
           "10.Which among the following headstreams meets the Ganges in last?"]

first_option=["Saraswati", "Assam",
              "Lal Bahadur Shastri", "ICICI Bank",
              "Lata Mangeshkar", "Sir Alexander Fleming",
              "Ranchi", "Sonia Gandhi", "Konark Temple", "Alaknanda"]


second_option=["Lakshmi", "TamilNadu",
               "Indira Gandhi", "State Bank of India",
               "Ajit Pal Singh", "Stephen Hawking",
               "Vijayawada", "L.K.Advani", "Khajuraho temples", "Pindar"]

third_option=["Satyanarayana", "Kerala",
              "V.P.Singh", "Punjab National Bank",
              "Vijaya Lakshmi Pandit", "Charles Darwin",
              "Vadodara", "Nelson Mandela", "Mahabalipuram temple", "Mandakini"]

fourth_option=["Vinayaka", "Andhra Pradesh",
               "Jawaharlal Nehru", "HDFC Bank",
               "Sarojini Naidu","Louis Pateur", "Allahabad","Benazir Bhutto", "Sun temple", "Bhagirathi"]
